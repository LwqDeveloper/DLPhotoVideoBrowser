...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of DLPhotoVideoBrowser.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lee_weiqiong@163.com/DLPhotoVideoBrowser'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lee_weiqiong@163.com' => 'lee_weiqiong@163.com' }
  s.source           = { :git => 'https://github.com/lee_weiqiong@163.com/DLPhotoVideoBrowser.git', :tag => s.version.to_s }
